    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img class="w-auto h-9" src="https://drive.google.com/uc?export=view&id=1DydJkmBK6PQUAaohBzNMYEqdyhYx0D81" alt="" />
        ...
        <p class="text-sm text-center text-gray-600">© Copyright 2023, All Rights Reserved by Betterview</p>
    </div>
</section>
  )
}
